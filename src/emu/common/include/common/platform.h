...
#if !EKA2L1_PLATFORM(VITA) && (defined(__vita__) || defined(__PSP2__))
#define EKA2L1_PLATFORM_VITA 1
#endif
...
#if EKA2L1_PLATFORM(ANDROID) || EKA2L1_PLATFORM(UNIX) || EKA2L1_PLATFORM(MACOS) || EKA2L1_PLATFORM(IOS) || EKA2L1_PLATFORM(VITA)
