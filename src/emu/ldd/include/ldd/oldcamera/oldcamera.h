...
namespace eka2l1::ldd {
    class old_camera_channel : public channel {
    public:
        explicit old_camera_channel(kernel_system *kern, system *sys, epoc::version ver);
        ~old_camera_channel() override {}
     ...
     */
    class old_camera_factory : public factory {
    public:
        explicit old_camera_factory(kernel_system *kern, system *sys);

        ~old_camera_factory() override {
        }
