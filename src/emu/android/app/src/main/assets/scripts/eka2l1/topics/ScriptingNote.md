...
EKA2L1 provides a *Lua scripting API* for interacting with the emulator, aiding debugging, reverse-engineering, and analysis tasks without touching the core C++ code of the emulator.
