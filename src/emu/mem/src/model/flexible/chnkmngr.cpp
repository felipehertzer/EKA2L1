...
namespace eka2l1::mem::flexible {
    ...
    bool chunk_manager::contains(const flexible_mem_model_chunk *chunk) const {
        return std::find_if(chunks_.begin(), chunks_.end(), [chunk](const std::unique_ptr<flexible_mem_model_chunk> &instance) {
