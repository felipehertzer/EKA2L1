...
namespace eka2l1 {
     ...
     *
     * Driver in EKA2L1 hides platform-specific rendering details. Clients send requests to the graphics
     * driver instead of talking to the Vulkan implementation directly.
     */
    namespace drivers {
