...
namespace eka2l1::dispatch {
    ...
    BRIDGE_FUNC_LIBRARY(void, vg_render_to_mask_emu, VGPath path, VGbitfield paintModes, VGMaskOperation operation) {
        ...
        // Mask rendering is still not implemented, but exporting a real stub
        // avoids sending patched OpenVG ordinal 86 into an unregistered bridge.
        context->set_error(VG_ILLEGAL_ARGUMENT_ERROR);
    }
