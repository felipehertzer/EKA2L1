...
namespace eka2l1::dispatch {
    ...
    public:
        ...
        enum {
            ...
            FRAGMENT_STATE_CLIP_PLANE_BIT_POS = 8,
            FRAGMENT_STATE_CLIP_PLANE0_ENABLE = 1 << 8,
            FRAGMENT_STATE_CLIP_PLANE1_ENABLE = 1 << 9,
            FRAGMENT_STATE_CLIP_PLANE2_ENABLE = 1 << 10,
            FRAGMENT_STATE_CLIP_PLANE3_ENABLE = 1 << 11,
            FRAGMENT_STATE_CLIP_PLANE4_ENABLE = 1 << 12,
            FRAGMENT_STATE_CLIP_PLANE5_ENABLE = 1 << 13,
            ...
            VERTEX_STATE_LIGHTING_ENABLE = 1 << 19,
            VERTEX_STATE_LIGHT0_ON = 1 << 20,
            VERTEX_STATE_LIGHT1_ON = 1 << 21,
            VERTEX_STATE_LIGHT2_ON = 1 << 22,
            VERTEX_STATE_LIGHT3_ON = 1 << 23,
            VERTEX_STATE_LIGHT4_ON = 1 << 24,
            VERTEX_STATE_LIGHT5_ON = 1 << 25,
            VERTEX_STATE_LIGHT6_ON = 1 << 26,
            VERTEX_STATE_LIGHT7_ON = 1 << 27,
            VERTEX_STATE_LIGHT_TWO_SIDE = 1 << 28,
            VERTEX_STATE_COLOR_MATERIAL_ENABLE = 1 << 29,
            VERTEX_STATE_LIGHT_AROUND_MASK = 0b11111111 << 20,
            VERTEX_STATE_LIGHT_RELATED_MASK = 0b111111111 << 20,
