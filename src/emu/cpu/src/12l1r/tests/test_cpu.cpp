...
namespace eka2l1::arm {
    ...
    std::unique_ptr<r12l1_core> make_test_cpu(test_env &environment) {
        ...
        core->read_16bit = [environment_ptr](const address addr, std::uint16_t *result) {
            *result = *reinterpret_cast<std::uint16_t *>(reinterpret_cast<std::uint8_t *>(environment_ptr->code_.data()) + addr);
        ...
        core->read_32bit = [environment_ptr](const address addr, std::uint32_t *result) {
            *result = *reinterpret_cast<std::uint32_t *>(reinterpret_cast<std::uint8_t *>(environment_ptr->code_.data()) + addr);
        ...
        core->read_64bit = [environment_ptr](const address addr, std::uint64_t *result) {
            *result = *reinterpret_cast<std::uint64_t *>(reinterpret_cast<std::uint8_t *>(environment_ptr->code_.data()) + addr);
