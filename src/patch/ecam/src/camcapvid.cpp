...
void CCameraPlugin::StartVideoCapture() {
    ...
    TRAPD(err, iVideoCapture.StartCaptureL(iVideoCaptureSizeIndex, iVideoCaptureFrameRateIndex, (CCamera::TFormat)iVideoCaptureFormat, iVideoFramesPerBuffer, iVideoCaptureNeedClip ? &iVideoCaptureClipRect : NULL));
